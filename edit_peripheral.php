...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "SELECT * FROM peripherals WHERE device_id = '$id'");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $type = $_POST['type'];
    // ...get other fields...
    $sql = "UPDATE peripheral SET type='$type' WHERE device_id='$id'";
    // Add other fields to the update query as needed
    mysqli_query($conn, $sql);
    header("Location: viewallperipheral.php");
    exit();
}
?>
